...
```
- [CLICK to view - Elk-Server-Deployment Playbook](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/elk-server-deployment.yml)
- [CLICK to view - FileBeat Deployment Playbook](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/filebeat-playbook.yml)
- [CLICK to view - MetricBeat Deployment Playbook](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/metricbeat-playbook.yml)
...
![alt text](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/ElkServerAutomation.png?raw=true)
...
![](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/ezgif-6-f88aa07dc25f.gif)
```diff
...
```
   - [CLICK to view - Elk-Server-Deployment.yml](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/elk-server-deployment.yml)
```diff
...
change them.
```
   - [CLICK to view - Ansible.cfg](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/Ansible.cfg)
```diff
...
```
   - [CLICK to view - Ansible Hosts File](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/hosts)
```diff
...
![alt text](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/PlaybookOutput.png)
...
![alt text](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/ElkServerAutomation.png)
...
![alt text](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/Kibana.png)
...
```
   - [CLICK to view - Filebeat-Configuration.yml](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/filebeat-configuration.yml)
   - [CLICK to view - Filebeat-Playbook.yml](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/filebeat-playbook.yml)
   - [CLICK to view - Metricbeat-Confgiuration.yml](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/metricbeat-configuration.yml)
   - [CLICK to view - Metricbeat-Playbook.yml](https://github.com/IrishLuck1/Elk-Stack/blob/main/Ansible/metricbeat-playbook.yml)
```diff
...
![alt text](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/filebeatinstall.png)
```diff
...
![alt text](https://github.com/IrishLuck1/Elk-Stack/blob/main/ScreenShots/Filebeat.png)
